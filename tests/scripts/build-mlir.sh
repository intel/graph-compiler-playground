...
# This might require an updat
pip install --pre torch==2.2.0.dev20231105 torchvision==0.17.0.dev20231105+cpu --index-url https://download.pytorch.org/whl/nightly/cpu
